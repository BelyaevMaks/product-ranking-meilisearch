...
**Полное пошаговое описание обработки данных и формул:** [PIPELINE_AND_SCORING_REFERENCE.md](PIPELINE_AND_SCORING_REFERENCE.md) — используйте его для синхронизации команды.
